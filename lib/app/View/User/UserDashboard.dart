...
class UserDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Journals World",style: TextStyle(fontWeight: FontWeight.bold),),
      ...
      body: FutureBuilder(future: ApiService.fetchJournals(), builder: (context,snapshot){
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, index) {
              var journals = snapshot.data[index];
              return Card(
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      IconButton(icon: Icon(Icons.delete), onPressed: () {
                        controller.deletePost(journals.id.toString());
                      }),
                    ],
                  ),
                ),
